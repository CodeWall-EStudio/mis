...
/***/ function(module, exports, __webpack_require__) {
	...
	//模板引用
	var tmpl = {
		area : __webpack_require__(42),
		manage : __webpack_require__(28), //管理员
		list : __webpack_require__(43),  //主题列表
		head : __webpack_require__(44),  //主题详情头部
		onemanage : __webpack_require__(29), //单个管理员
		aside : __webpack_require__(45),  //主题详情右边资源列表
		rlist : __webpack_require__(35)   //资源列表
	};
	            ...
	            (function() {
	                ...
	                for (var i in resourceList) {
	                    ...
	                    if (item.type === 1) {
	                        ...
	                        buf.push('\n              <video src="/cgi/resource/preview?id=', (__stack.lineno = 29, item.id), '" controls="controls">\n              您的浏览器不支持 video 标签。\n              </video>\n              <a data-id="', (__stack.lineno = 32, item.id), '"  data-action="mark" style="display:none;">标注</a>  <a data-id="', (__stack.lineno = 32, item.id), '"  data-action="review">预览</a>  <a href="/cgi/resource/download?id=', (__stack.lineno = 32, item.id), '" target="_blank">下载</a>\n              ');
	                        __stack.lineno = 33;
	                        if (my.auth || my.id === creator) {
