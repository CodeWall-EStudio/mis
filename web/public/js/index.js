...
/***/ function(module, exports, __webpack_require__) {
	...
	var tmpl = {
		nav : __webpack_require__(22),
		manage : __webpack_require__(20),
		onemanage : __webpack_require__(21)
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tmpl = {
		...
		manage : __webpack_require__(20), //管理员
		list : __webpack_require__(17),  //主题列表
		head : __webpack_require__(18),  //主题详情头部
		onemanage : __webpack_require__(21), //单个管理员
		aside : __webpack_require__(19),  //主题详情右边资源列表
	            ...
	            (function() {
	                ...
	                for (var i in resourceList) {
	                    ...
	                    if (item.type === 1) {
	                        ...
	                        buf.push('\n              <video src="/cgi/resource/preview?id=', (__stack.lineno = 30, item.id), '" controls="controls">\n              您的浏览器不支持 video 标签。\n              </video>\n              <a data-action="reviewResource" data-id="', (__stack.lineno = 33, item.id), '">预览</a>  <a href="/cgi/resource/download?id=', (__stack.lineno = 33, item.id), '" target="_blank">下载</a>\n              ');
	                        __stack.lineno = 34;
	                        if (my.auth || my.id === creator) {
	                            buf.push('\n                <a data-action="deleteResource">删除</a>\n              ');
	                            __stack.lineno = 36;
	                        ...
	                        buf.push("\n            <div>\n              <p>", (__stack.lineno = 39, item.name), '</p>\n              <a href="/cgi/resource/download?id=', (__stack.lineno = 40, item.id), '" target="_blank">下载</a>\n              ');
	                        __stack.lineno = 41;
	                        if (my.auth || my.id === creator) {
	                            buf.push('\n                <a data-action="deleteResource">删除</a>\n              ');
	                            __stack.lineno = 43;
