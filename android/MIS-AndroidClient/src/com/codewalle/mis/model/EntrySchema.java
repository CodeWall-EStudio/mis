...
import com.codewalle.framework.utils.AssertUtils;
...
public final class EntrySchema {
    ...
    public static class EntryManager{
        private static Set<EntrySchema> schemas = new HashSet<EntrySchema>(5);
        public static void addEntrySchema(EntrySchema schema){
            synchronized (EntryManager.class) {
                schemas.add(schema);
            }
        }
        public static void onCreate(SQLiteDatabase db){
            Iterator<EntrySchema> it = schemas.iterator();
            while(it.hasNext()){
                EntrySchema schema = it.next();
    ...
    public EntrySchema(Class<? extends Entry> clazz) {
        EntryManager.addEntrySchema(this);
    ...
    public void createTables(SQLiteDatabase db) {
        ...
        AssertUtils.assertTrue(tableName != null);
